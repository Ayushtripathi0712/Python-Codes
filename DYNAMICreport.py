...
class PaymentProcessor:
    """The Strategy-pattern Context. Delegates work to active PaymentStrategy."""
    _registry = {}
    ...
    def register_strategy(cls, key, strategy_cls):
        """Register a new payment method under a key, e.g., 'upi'."""
    ...
    def create(cls, key, **kwargs):
        """Factory helper to build a PaymentProcessor configured by key."""
...
if __name__ == "__main__":
    ...
    # Test invalid strategy credentials
